...
class Energy
{
    ...
    public
    function spend(int $amount): bool {
        $amount = abs($amount);
        ...
        if ($this->rechargeHandler === null) $this->startRecharge();;
        if ($this->rechargeHandler->isCancelled()) $this->startRecharge();
        return true;
    }
     ...
     */
    public
    function getInitialMaxValue(): int {
